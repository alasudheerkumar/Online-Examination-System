    ...
    if(@$_GET['q']==7 && @$_GET['z'] == NULL)
    {
      ...
      echo'<script>
              var courses = {
            		...
            		"M.Tech": {"I year": ["Civil Engineering","Chemical Engineering","Computer Science & Engineering", "Electronics & Communication Engineering","Electical & Electronic Engineering","Mechanical Engineering"],"IIyear": ["Civil Engineering","Chemical Engineering","Computer Science & Engineering", "Electronics & Communication Engineering","Electical & Electronic Engineering","Mechanical Engineering"],},
            ...
            window.onload = function ()
            {
              ...
              department.onchange = function ()
              {
                ...
                xmlhttp.open("POST","dash.php?q=7&x="+course1+"&y="+year1+"&z="+dep1,true);
                xmlhttp.send();
