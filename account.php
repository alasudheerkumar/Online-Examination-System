...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td><b>Average</b></td><td></td></tr>';
$c=1;
...
if(@$_GET['q']== 'quiz' && @$_GET['step']== 2)
{
  ...
  while($row=mysqli_fetch_array($q) )
  {
    ...
    $option4=$row['option4'];
    $answer=$row['answer'];
    echo'<input type="radio" name="ans" value="a">'.$option1.'<br /><br />';
    echo'<input type="radio" name="ans" value="b">'.$option2.'<br /><br />';
    echo'<input type="radio" name="ans" value="c">'.$option3.'<br /><br />';
    echo'<input type="radio" name="ans" value="d">'.$option4.'<br /><br />';
